...
def get_count_oscillations(initial_amplitude: float, final_amplitude: float) -> int:
    count_oscillations = 0
    while initial_amplitude > final_amplitude:
        count_oscillations += 1
        initial_amplitude = initial_amplitude * (100 - DAMPING)/100
    return count_oscillations
...
print(
    f"Маятник считается остановившимся через {get_count_oscillations(initial_amplitude, final_amplitude)} колебаний")
